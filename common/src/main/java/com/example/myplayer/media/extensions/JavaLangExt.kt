package com.example.myplayer.media.extensions
...
/**
 * Helper method to check it a [String] contains another in a case insensitive way
 */
...
/**
 * Helper extension to URL encoding a [String]. Returns an empty string when called on null.
 */
